...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"..\\..\\AppData\\Local\\Yarn\\Data\\global\\node_modules\\parcel\\src\\builtins\\css-loader.js"}],"app1\\app1.css":[function(require,module,exports) {
...
},{"process":"..\\..\\..\\AppData\\Local\\Yarn\\Data\\global\\node_modules\\process\\browser.js"}],"app1\\app1.js":[function(require,module,exports) {
'use strict';
...
var $operation = (0, _jquery2.default)('.operation');
var n = localStorage.getItem("n");
$number.text(n || 100);

$operation.on("click", "button", function (e) {
    var $button = (0, _jquery2.default)(e.currentTarget);
    var index = $button.index();
    if (index === 0) {
        var _n = parseInt($number.text());
        _n += 1;
        localStorage.setItem("n", _n);
        $number.text(_n);
    } else if (index === 1) {
        var _n2 = parseInt($number.text());
        _n2 -= 1;
        localStorage.setItem("n", _n2);
        $number.text(_n2);
    } else if (index === 2) {
        var _n3 = parseInt($number.text());
        _n3 *= 2;
        localStorage.setItem("n", _n3);
        $number.text(_n3);
    } else if (index === 3) {
        var _n4 = parseInt($number.text());
        _n4 /= 2;
        localStorage.setItem("n", _n4);
        $number.text(_n4);
    }
});
},{"./app1.css":"app1\\app1.css","jquery":"..\\node_modules\\jquery\\dist\\jquery.js"}],"main.js":[function(require,module,exports) {
'use strict';
...
},{"./global.css":"global.css","./reset.css":"reset.css","./app1/app1.js":"app1\\app1.js"}],"..\\..\\..\\AppData\\Local\\Yarn\\Data\\global\\node_modules\\parcel\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/main.d4ac8a0e.map